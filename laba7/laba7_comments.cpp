...
public:
    Product() : name(""), quantity(0), price(0.0) {} //пустой конструктор - значения по умолчанию
    Product(string n, int q, double p) // конструктор с параметрами - сами задаем значения полей
...
// Предикат (find_if)
bool isLowQuantity(const Product& p) { //булева функция, возвращает true - если малый объем
